...
<div class="container-products m-5">
    <h4 class="text-center mt-5 font-weight-light text-uppercase"><span class="font-weight-normal">${firstName}</span>! Mira todos los productos que tenemos para ti!</h4>
    <div class="row">
        <c:choose>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="https://${product.getSupplier().getWebsiteUrl()}" target="_blank" class="card-text float-right"><c:out value="${ product.getSupplier().getName() }"/></a>
                                </div>
                            </div>
                            ...
                            <div id="accordion_<c:out value="${counter}"/>">
                                ...
                                <div id="collapse_more_info_<c:out value="${counter}"/>" class="collapse" aria-labelledby="collapse_text_<c:out value="${counter}"/>" data-parent="#accordion_<c:out value="${counter}"/>">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text font-weight-bold">Sitio Web: 
                                            <span class="font-weight-light"><c:out value="${ product.getSupplier().getWebsiteUrl() }"/></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
