...
<style>
    .face {
        background:url('${pageContext.request.contextPath}/src/portal-client/src/img/card-face-category.jpg') top/100% auto no-repeat;
    }
    .hair{
        background:url('${pageContext.request.contextPath}/src/portal-client/src/img/card-hair-category.jpg') top/100% auto no-repeat;
    }
    .skin{
        background:url('${pageContext.request.contextPath}/src/portal-client/src/img/card-skin-category.png') top/100% auto no-repeat;
    }
    .face-mask{
        background:url('${pageContext.request.contextPath}/src/portal-client/src/img/card-mask-category.jpg') top/100% auto no-repeat;
    }
    .overlay{
...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <a href="${pageContext.request.contextPath}/app/categories?products=1">
                <div class="card">
        ...
        <div class="col">
            <a href="${pageContext.request.contextPath}/app/categories?products=2">
                <div class="card">
    ...
    <div class="row mt-3">
        <div class="col">
            <a href="${pageContext.request.contextPath}/app/categories?products=3">
                <div class="card">
        ...
        <div class="col">
            <a href="${pageContext.request.contextPath}/app/categories?products=4">
                <div class="card">
